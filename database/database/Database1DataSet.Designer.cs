...
namespace database {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TableRow AddTableRow(int student_id, string name_, int sem) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public int sem {
                get {
                    try {
                        return ((int)(this[this.tableTable.semColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'sem\' in table \'Table\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable.semColumn] = value;
                }
            }
            ...
            public bool IssemNull() {
                return this.IsNull(this.tableTable.semColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetsemNull() {
                this[this.tableTable.semColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace database.Database1DataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([student id] = @Original_student_id) AND ((@IsN" +
                "ull_name_ = 1 AND [name ] IS NULL) OR ([name ] = @Original_name_)) AND ((@IsNull" +
                "_sem = 1 AND [sem] IS NULL) OR ([sem] = @Original_sem)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([student id], [name ], [sem]) VALUES (@student_id, @na" +
                "me_, @sem);\r\nSELECT [student id], [name ], sem FROM [Table] WHERE ([student id] " +
                "= @student_id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [student id] = @student_id, [name ] = @name_, [sem] = @sem WHERE (([student id] = @Original_student_id) AND ((@IsNull_name_ = 1 AND [name ] IS NULL) OR ([name ] = @Original_name_)) AND ((@IsNull_sem = 1 AND [sem] IS NULL) OR ([sem] = @Original_sem)));
SELECT [student id], [name ], sem FROM [Table] WHERE ([student id] = @student_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [student id], [name ], sem FROM dbo.[Table]";
